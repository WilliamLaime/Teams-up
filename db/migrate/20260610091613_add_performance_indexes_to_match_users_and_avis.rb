class AddPerformanceIndexesToMatchUsersAndAvis < ActiveRecord::Migration[8.1]
  def change
    ...
    add_index :match_users, [:user_id, :status], name: "index_match_users_on_user_id_status"
    ...
    add_index :avis, [:reviewed_user_id, :mutual], name: "index_avis_on_reviewed_user_id_mutual"
  end
end
