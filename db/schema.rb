...
ActiveRecord::Schema[8.1].define(version: 2026_09_04_140000) do
  ...
  create_table "slack_favorite_destinations", force: :cascade do |t|
    t.string "channel_id", null: false
    t.string "channel_name", null: false
    t.datetime "created_at", null: false
    t.bigint "slack_identity_id", null: false
    t.datetime "updated_at", null: false
    t.index ["slack_identity_id", "channel_id"], name: "idx_on_slack_identity_id_channel_id_2d463afa3c", unique: true
    t.index ["slack_identity_id"], name: "index_slack_favorite_destinations_on_slack_identity_id"
  end
  ...
  create_table "tournament_rounds", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.integer "expected_matches"
    t.integer "number", null: false
    t.string "phase", null: false
    t.string "status", default: "pending", null: false
    t.bigint "tournament_id", null: false
    t.datetime "updated_at", null: false
    t.index ["tournament_id", "phase", "branch", "number"], name: "index_tournament_rounds_on_tid_phase_branch_number", unique: true
    t.index ["tournament_id"], name: "index_tournament_rounds_on_tournament_id"
  end

  create_table "tournament_users", force: :cascade do |t|
    t.boolean "co_organizer", default: false, null: false
    t.datetime "created_at", null: false
  ...
  add_foreign_key "slack_favorite_destinations", "slack_identities"
