...
- **Destinataires** (`ChatEmailDigest.participant_ids_for`) : les participants du chat, sauf l'expéditeur. Exception pour le match de tournoi : les organisateurs (créateur + co-organisateurs) ont accès à tous les chats mais ne sont notifiés que de ceux où ils ont déjà écrit ; ceux qui jouent la confrontation sont notifiés comme joueurs.
